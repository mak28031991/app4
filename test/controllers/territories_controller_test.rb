...
class TerritoriesControllerTest < ActionController::TestCase
  ...
  test "should create territory" do
    assert_difference('Territory.count') do
      post :create, territory: { RegionID: @territory.RegionID, TerritoryDescription: @territory.TerritoryDescription }
    end
  ...
  test "should update territory" do
    patch :update, id: @territory, territory: { RegionID: @territory.RegionID, TerritoryDescription: @territory.TerritoryDescription }
    assert_redirected_to territory_path(assigns(:territory))
  end
